...
// in simulator we redefine to format for bhejde Developer console
...
{\
	NSString * exceptionName = [@"org.bhejde." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.bhejde";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIbhejdeNativeItemNone = -1, 
	UIbhejdeNativeItemSpinner = -2,
	UIbhejdeNativeItemProgressBar = -3,
	
	UIbhejdeNativeItemSlider = -4,
	UIbhejdeNativeItemSwitch = -5,
	UIbhejdeNativeItemMultiButton = -6,
	UIbhejdeNativeItemSegmented = -7,
	
	UIbhejdeNativeItemTextView = -8,
	UIbhejdeNativeItemTextField = -9,
	UIbhejdeNativeItemSearchBar = -10,
	
	UIbhejdeNativeItemPicker = -11,
	UIbhejdeNativeItemDatePicker = -12,
	
	UIbhejdeNativeItemInfoLight = -13,
	UIbhejdeNativeItemInfoDark = -14,
	
	UIbhejdeNativeItemDisclosure = -15,
	
	UIbhejdeNativeItemContactAdd = -16
};
